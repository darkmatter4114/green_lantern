...
from apps.cars.views import ListOfCarsViews
from apps.cars.views import CarInfo
from apps.photos.views import image_view
from apps.orders.views import create_view
...
urlpatterns = [
    ...
    path('cars/list/', ListOfCarsViews.as_view(), name='list_car'),
    path('cars/info/', CarInfo.as_view(), name='car_info'),
    path('upload', image_view, name='image_upload'),
    path('create_order', create_view, name='create_order'),
]
